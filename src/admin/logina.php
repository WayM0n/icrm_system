...
<body id="form" >
    ...
    <section class="vh-100 ">
        <div class="container h-custom form ">
          <div class="row d-flex justify-content-center align-items-center h-100">
                    <!-- <div class="col-md-9 col-lg-6 col-xl-5">
                      <img src="./assets/img/Login-page.png" class="img-fluid"
                        alt="Sample image" width="450px" height="250px">
                    </div> -->
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 shadow-lg border-5 ">
                                    ...
                                    <form action="./login.php" method="post" enctype="multipart/form-data" > 
                                        ...
                                        <div>
                                          ...
                                          <p class="bg-success text-white mt-5 rounded-2    shadow-lg fs-5  px-4">
                                            ...
                                            <input type="password" name="password" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$"  value="<?php
                                            if (isset($_COOKIE['passwordcookie'])) {
                                              echo $_COOKIE['passwordcookie'];
                                            }
                                            ?>"    placeholder="mon@45fgvc" id="password" class="form-control" required>
                                            <div>
