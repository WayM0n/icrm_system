...
<!------ Include the above in your HEAD tag ---------->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="text-center" ><span class=" mb-2 fa fa-check fs-1 shadow-lg text-white bg-primary p-3 rounded-5 shadow-lg "></span></div>
                    <div>
                    <h1 class="text-center" >Password reset</h1>
                    <p class="text-center text-white" >Your password has been successfully reset.<br>
                    Click below to login magically</p>
                    <form action="./recover_email1.php">
                    <div class="form-group text-center">
                    <a href="./logina.php" name="submit"  class="reset form-control mt-1 text-center border border-0 btn text-white fw-bold w-50 p-3 rounded-4" >Continue</a>
                    </form>
