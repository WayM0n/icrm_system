<?php
    ...
    if(isset($_SESSION['id'])){
        ...
        if(isset($_POST["btnSubmit"])){
            ...
            $sql_update_full = "UPDATE `user_full_details` SET `city`=:city,`district`=:district,`state`=:state,`pin_code`=:pin_code,`aadhar_card`=:aadhar_card,`dob`=:dob,`gender`=:gender,`tehsil`=:tehsil , `plan_type`=:plan_type WHERE u_id=:id ";
            ...
            $prepared_full->bindParam(':plan_type', $_POST['plan_type']);
