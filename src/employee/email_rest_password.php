            ...
            <div class="row">
                ...
                <div class="text-center" ><span class=" mb-2 fa fa-key fs-1 text-white bg-primary p-2 rounded-5 "></span></div>
                    ...
                    <form action="./email_rest_password_1.php" method="post" enctype="multipart/form-data" >
                        ...
                        <input type="password" class="form-control mb-3" name="password" id="password" placeholder="Password *" value="" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$"  required/>
                        ...
                        <input type="password" class="form-control mb-3" name="cpassword" id="cpassword" placeholder="Confirm Password *" value="" pattern="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$"  required/>
                        </div>
