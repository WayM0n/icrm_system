                            ...
                            <form action="updateProfilePic.php" method="post" enctype="multipart/form-data">
                                    <div class="text-center">
                                        ...
                                        <div class="mt-2 text-start fw-semibold">
                                            ...
                                            <input type="file" accept="image/*"    class="form-control" name="new_profile_pic" id="new_profile_pic" value="<?php echo $pic[2] ?>" required >
                                        </div>
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        <div class="mt-2 text-start fw-semibold">
                                            ...
                                            <input type="text" class="form-control" name="f_name" id="f_name" value="<?php echo $result['f_name']?>"  required>
                                        </div>

                                        <div class="mt-2 text-start fw-semibold">
                                            <label for="l_name" class="pb-2">Last Name</label>
                                            <input type="text" class="form-control" name="l_name" value="<?php echo $result['l_name']?>"  id="l_name" required>
                                        </div>
                                        ...
                                        <div class="mt-2 text-start fw-semibold">
                                            ...
                                            <input type="tel" class="form-control" name="phone" maxlength="10"  value="<?php echo $result['contact']?>"  id="phone" minlength="10">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-2 text-start fw-semibold">
                                            ...
                                            <input type="text" class="form-control" name="aadhar_card" value="<?php echo $result['aadhar_card']?>" id="aadhar" required>
                                        </div>
                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="card-body">
                                        <div class="mt-2 text-start fw-semibold">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $result['city']?>" name="city" id="city" required>
                                        </div>

                                        <div class="mt-2 text-start fw-semibold">
                                            <label for="tehsil" class="pb-2">Tehsil</label>
                                            <input type="text" class="form-control" name="tehsil" id="tehsil" value="<?php echo $result['tehsil']?>" required>
                                        </div>

                                        <div class="mt-2 text-start fw-semibold">
                                            <label for="distt" class="pb-2">District</label>
                                            <input type="text" class="form-control" name="district" value="<?php echo $result['district']?>" id="distt" required>
                                        </div>

                                        <div class="mt-2 text-start fw-semibold">
                                            <label for="pincode" class="pb-2">Pin Code</label>
                                            <input type="text" class="form-control" value="<?php echo $result['pin_code']?>" name="pin_code" id="pincode" required>
                                        </div>

                                        <div class="mt-2 text-start fw-semibold">
                                            <label for="state" class="pb-2">State</label>
                                            <input type="text" class="form-control" name="state" value="<?php echo $result['state']?>" id="state" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
