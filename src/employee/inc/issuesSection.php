                        ...
                        <div class="card-body">
                            <form action="./processIssue.php" method="post">
                                <div class="form-floating mb-3">
                                    <input class="form-control fw-semibold" type="text" name="title" id="title" placeholder="Issue">
                                    <label for="email">Title</label>
                                </div>
                                <div class="form-floating mb-3" >
                                    <textarea class="form-control" id="desc" placeholder="Something..." name="description"></textarea>
...
$sql_issue = "SELECT * FROM `employees_issues` WHERE raised_by=:raised_by ORDER BY raised_on DESC";
